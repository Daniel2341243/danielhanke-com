  ...
  return (
    <Section>
      ...
      <Prose>
        ...
        <h2>{isDe ? "6. YouTube-Videos (nur mit Einwilligung)" : "6. YouTube Videos (consent-gated)"}</h2>
        <p>
          {isDe
            ? "Auf der Startseite kann das jeweils neueste Video unseres YouTube-Kanals direkt eingebettet werden. Die Einbindung erfolgt im erweiterten Datenschutzmodus über youtube-nocookie.com und wird ausschließlich geladen, wenn du im Cookie-Banner „Alle akzeptieren“ wählst oder auf der Video-Platzhalter-Fläche „YouTube laden“ klickst. Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Mit Aktivierung verbindet sich dein Browser direkt mit YouTube/Google; dabei werden u. a. deine IP-Adresse, Geräte- und Browserdaten verarbeitet und ggf. Cookies gesetzt. Rechtsgrundlage ist deine Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO. Die US-Übermittlung stützt sich auf den EU-US Data Privacy Framework bzw. Standardvertragsklauseln. Du kannst deine Einwilligung jederzeit widerrufen, indem du den Local-Storage-Eintrag „consent“ entfernst und neu wählst. Ohne Einwilligung wird kein YouTube-Inhalt geladen; statt des Videos siehst du einen Platzhalter mit Link auf YouTube."
            : "On the homepage the latest video from our YouTube channel may be embedded directly. Embedding uses YouTube's privacy-enhanced mode via youtube-nocookie.com and only loads if you select 'Accept all' in the cookie banner or click 'Load YouTube' on the video placeholder. Provider is Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Ireland. On activation your browser connects directly to YouTube/Google; your IP address, device and browser data are processed and cookies may be set. Legal basis is your consent per Art. 6 (1) (a) GDPR. The US transfer is based on the EU-US Data Privacy Framework and/or Standard Contractual Clauses. You can revoke consent anytime by clearing the 'consent' entry in local storage. Without consent no YouTube content is loaded; you see a placeholder with a link to YouTube instead."}
        </p>
